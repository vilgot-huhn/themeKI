...
theme_KI <- function(...){
  ...
  ggplot2::theme(
    ...
    panel.border = element_rect(fill = NULL, color = KI_theme_colors["border"],linewidth= NULL),
    ...
    legend.background = element_rect(fill = KI_theme_colors["panel"], color = NULL),
...
theme_KI_2 <- function(...){
  ...
  ggplot2::theme(
    ...
    panel.border = element_rect(fill = NULL, color = KI_theme_colors_2["border"],linewidth= NULL),
    axis.title = element_text(size=18),
    axis.text = element_text(size=15,color = KI_theme_colors_2["text"]),
    axis.ticks = element_blank(),
    legend.background = element_rect(fill = KI_theme_colors_2["panel"], color = NULL),
